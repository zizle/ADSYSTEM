...
class ContractKei(ContractKeiUI):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.web_page.load(QUrl("file:///E:/ADSYSTEM/fontGUI/pages/kline.html"))
        # self.web_container.setPage(self.web_page)
        # self.web_container.load(QUrl("file:///E:/ADSYSTEM/fontGUI/pages/kline.html"))
        # self.web_container.setHtml("""<div style="width: 200px;height: 300px; background-color: blue"></div>""")
    ...
    def get_kline_data(self):
        ...
        # l = QHBoxLayout()
        # w = QWebEngineView()
        # # u = QUrl.fromLocalFile("E:/ADSYSTEM/fontGUI/pages/kline.html")
        # u = QUrl("https://www.baidu.com/")
        # w.load(u)
        # l.addWidget(w)
        # popup.setLayout(l)
        # popup.exec_()
